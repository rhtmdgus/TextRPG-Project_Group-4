...
JNPC JNPC1 = { "관군NPC", {25, 15} };
RNPC RNPC1 = { "의병NPC", {30, 15} };
WNPC WNPC1 = { "왜군NPC", {35, 15} };
...
void displayMap()
{
	...
	for (int i = 0; i < MAP_HEIGHT; i++)
	{
		...
		if (i == 4) printf("  MANA: %d", player.mana);
		...
		if (i == 9) printf("  mana potion: %d", player.MANApotion);
		if (i == 10) printf("  관군과의 관계: %d", player.JRelationship);
		if (i == 11) printf("  의병과의 관계: %d", player.RRelationship);
		if (i == 12) printf("  왜군과의 관계: %d", player.WRelationship);
...
void drawNPC()
{
	setCursorPosition(JNPC1.pos.x, JNPC1.pos.y);
	printf("J");
	setCursorPosition(RNPC1.pos.x, RNPC1.pos.y);
	printf("R");
	setCursorPosition(WNPC1.pos.x, WNPC1.pos.y);
	printf("W");
}
...
int main()
{
	...
	map[JNPC1.pos.y][JNPC1.pos.x] = 'J';
	map[RNPC1.pos.y][RNPC1.pos.x] = 'R';
	map[WNPC1.pos.y][WNPC1.pos.x] = 'W';
